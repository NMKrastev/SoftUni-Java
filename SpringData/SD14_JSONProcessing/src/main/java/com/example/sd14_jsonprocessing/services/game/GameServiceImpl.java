...
import com.example.sd14_jsonprocessing.entities.dtos.game.GameDTO;
import com.example.sd14_jsonprocessing.entities.dtos.game.GameDetailedInfoDTO;
import com.example.sd14_jsonprocessing.entities.dtos.game.GameTitlePriceDTO;
...
public class GameServiceImpl implements GameService {
    ...
    public String addGame(String gameData) {
        ...
        final String title = "Game";//gameData[0];
        ...
        final BigDecimal price = BigDecimal.TEN;//BigDecimal.valueOf(Double.parseDouble(gameData[1]));
        final Double size = 20.0;//Double.parseDouble(gameData[2]);
        final String trailerId = "dawd32awddd";//gameData[3];
        final String thumbnailUrl = "https://dawdawdawdwada";//gameData[4];
        final String description = "dawdawdawd";//gameData[5];
        final LocalDate releaseDate = LocalDate.now();//LocalDate.parse(gameData[6], DateTimeFormatter.ofPattern("dd-MM-yyyy"));
