...
public class FruitMarket01 {
    public static void main(String[] args) {
        ...
        double totalStrawberryPrice = strawberryPrice * strawberryKg;
        double totalRaspberryPrice = strawberryPrice  - (strawberryPrice * 0.5);
        double totalOrangePrice = totalRaspberryPrice - (totalRaspberryPrice * 0.4);
        double totalBananaPrice = totalRaspberryPrice - (totalRaspberryPrice * 0.8);
        totalRaspberryPrice *= raspberryKg;
        totalOrangePrice *= orangeKg;
        totalBananaPrice *= bananaKg;

        System.out.printf("%.2f\n", totalStrawberryPrice + totalRaspberryPrice + totalOrangePrice +
                totalBananaPrice);
    }
}
