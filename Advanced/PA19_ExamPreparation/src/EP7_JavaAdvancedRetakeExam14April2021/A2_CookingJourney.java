...
public class A2_CookingJourney {
...
/*You will be given an integer n for the size of the pastry shop with a square shape. On the next n lines,
you will receive the rows of the pastry shop. You will be placed in a random position, marked with the letter 'S'.
On random positions, there will be clients, marked with a single digit. There may also be pillars.
Their count will be either 0 or 2 and they are marked with the letter - 'P'.
...
You need at least 50 dollars to rent your Pastry shop.
