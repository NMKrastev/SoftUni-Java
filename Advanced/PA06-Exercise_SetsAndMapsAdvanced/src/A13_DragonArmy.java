...
public class A13_DragonArmy {
    ...
    private static void printResult(Map<String, TreeMap<String, List<Integer>>> dragonInfoMap, List<Double> averageValues) {
        ...
        dragonInfoMap.forEach((type, dragonInfo) -> {
            System.out.printf("%s::(%.2f/%.2f/%.2f)\n", type, averageValues.get(listIndex[0]),
                    averageValues.get(listIndex[0] + 1), averageValues.get(listIndex[0] + 2));
            dragonInfo.forEach((name, stats) ->
